...
- Expenses simples y en cuotas.
- Debts y payments.
- Budgets, subBudgets e impacts.
- Income.
- Analytics dashboard.
- Imports Excel de gastos con preview y confirmacion.
...
- Reportes avanzados.
- Imports adicionales.
- Dashboard analytics final avanzado.
- Gestion completa de miembros desde UI.
...
- Expenses: crear gasto simple y gasto en cuotas.
- Debts: verificar deuda derivada, registrar pago parcial y bloquear sobrepago.
- Budgets: crear budget mensual, verificar impact y crear subBudget manual.
- Income: crear, actualizar y cancelar.
- Analytics: monthly summary, breakdowns, debt summary y budget summary.
- Imports: preview Excel con 1 fila valida y 1 invalida, confirmacion y creacion solo de filas validas.
...
No existe UI/service de `remove member` en el frontend actual.
...
- Completar gestion de miembros desde UI si entra en roadmap.
