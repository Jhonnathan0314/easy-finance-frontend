...
- Actions: change month/date range.
- Components: metric cards, category breakdown tables/charts.
- Errors: `ANALYTICS_PERIOD_INVALID`, `ANALYTICS_DATE_RANGE_INVALID`.
...
- Endpoints:
  - `/categories`
  - `/payment-methods`
- Actions: create, update, deactivate, filter.
...
- Actions: create simple, create installment, update/cancel simple, filter.
